...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 16 Apr 2027 00:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 16 Apr 2027 00:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        BEGIN EVENTINTERVAL
            ...
            StopEvent		
            BEGIN EVENT
                Epoch		 16 Apr 2030 00:00:00.000000000
                EpochState		 Explicit
            END EVENT
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            WindowRectLeft		 338
            WindowRectTop		 133
            WindowRectRight		 1906
            WindowRectBottom		 941
        END Report
...
"16 Apr 2027 00:00:00.000000000" "23 Apr 2027 16:05:52.730903917"
                        END Intervals
            ...
            WindowRectLeft		 364
            WindowRectTop		 156
            WindowRectRight		 1556
            WindowRectBottom		 880
        END Report

        BEGIN Report
            Name		 Maneuver Summary1
            Type		 Report
            BaseDir		 Install
            Style		 Maneuver Summary
            AGIViewer		 Yes
...
"16 Apr 2027 00:00:00.000000000" "23 Apr 2027 16:05:52.730903917"
            ...
            WindowRectLeft		 493
            WindowRectTop		 154
            WindowRectRight		 1685
            WindowRectBottom		 878
        END Report

        BEGIN Report
            Name		 Maneuver Summary2
            Type		 Report
            BaseDir		 Install
            Style		 Maneuver Summary
            AGIViewer		 Yes
...
"16 Apr 2027 00:00:00.000000000" "26 Apr 2027 00:00:00.000000000"
                        END Intervals
            ...
            WindowRectLeft		 473
            WindowRectTop		 167
            WindowRectRight		 1665
            WindowRectBottom		 891
        END Report

        BEGIN Report
            Name		 Maneuver Summary3
            Type		 Report
            BaseDir		 Install
            Style		 Maneuver Summary
            AGIViewer		 Yes
...
"16 Apr 2027 00:00:00.000000000" "10 Jun 2027 00:00:00.000000000"
                        END Intervals
            ...
            WindowRectLeft		 485
            WindowRectTop		 236
            WindowRectRight		 1677
            WindowRectBottom		 960
        END Report

        BEGIN Report
            Name		 Maneuver Summary4
            Type		 Report
            BaseDir		 Install
            Style		 Maneuver Summary
            AGIViewer		 Yes
...
"16 Apr 2027 00:00:00.000000000" "10 Jun 2027 00:00:00.000000000"
            ...
            WindowRectLeft		 486
            WindowRectTop		 206
            WindowRectRight		 1678
            WindowRectBottom		 930
        END Report

        BEGIN Report
            Name		 Maneuver Summary5
            Type		 Report
            BaseDir		 Install
            Style		 Maneuver Summary
            AGIViewer		 Yes
...
"16 Apr 2027 00:00:00.000000000" "16 Apr 2028 00:00:00.000000000"
                        END Intervals
            ...
            WindowRectLeft		 428
            WindowRectTop		 220
            WindowRectRight		 1620
            WindowRectBottom		 944
        END Report
    END QuickReports
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -2.36333e+08
            LaunchWindowStop		 -3.30941e+08
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 19 Oct 2019 16:00:00.000000000
                    Stop		 20 Oct 2019 16:00:00.000000000
                END Interval
        ...
        BEGIN ExportDataFile
            FileType		 Ephemeris
            Directory		 C:\Users\HAL - 9000\Dropbox\GT\Fall 2019\AE 4342\Project
...
<VAR name = "STK_Radar_Clutter_Extension">
    <SCOPE Class = "RadarClutterExtension">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 16 Apr 2027 00:00:00.000000000
                EndTime		 16 Apr 2030 00:00:00.000000000
                CurrentTime		 17 Apr 2027 00:30:00.000000000
                Direction		 Forward
                UpdateDelta		 1800
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        ...
                        SecondaryBody		 Sun
                        CenterLatitude		 0
                        CenterLongitude		 -44.20567297390613
                ...
                BEGIN MapStyles
                    ...
                    BEGIN Style
                        ...
                        BEGIN RecordMovie
                            OutputFormat		 WMV
                            Directory		 C:\Users\HAL - 9000\Dropbox\GT\Fall 2019\AE 4342\STK
                            BaseName		 Frame
                            Digits		 4
                            Frame		 0
                            LastAnimTime		 0
    ...
    BEGIN SubObjects
        ...
        Class Facility
            ...
            DSS_13_Goldstone_STDN_VEND		
            DSS_45_Tidbinbilla_STDN_DS45		
            DSS_65_Robledo_STDN_DS65		
    ...
    BEGIN References
        ...
        END Instance
        Instance Facility/DSS_13_Goldstone_STDN_VEND
            Constellation/DSN		
            Facility/DSS_13_Goldstone_STDN_VEND		
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo		
        END Instance
        Instance Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo		
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Receiver/DL_DSN		
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Transmitter/Uplink		
        END Instance
        Instance Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Receiver/DL_DSN
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Receiver/DL_DSN		
        END Instance
        Instance Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Transmitter/Uplink
            Facility/DSS_13_Goldstone_STDN_VEND/Sensor/Servo/Transmitter/Uplink		
        END Instance
        Instance Facility/DSS_45_Tidbinbilla_STDN_DS45
            Constellation/DSN		
            Facility/DSS_45_Tidbinbilla_STDN_DS45		
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo		
        END Instance
        Instance Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo		
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Receiver/DL_DSN		
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Transmitter/Uplink		
        END Instance
        Instance Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Receiver/DL_DSN
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Receiver/DL_DSN		
        END Instance
        Instance Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Transmitter/Uplink
            Facility/DSS_45_Tidbinbilla_STDN_DS45/Sensor/Servo/Transmitter/Uplink		
        END Instance
        Instance Facility/DSS_65_Robledo_STDN_DS65
            Constellation/DSN		
            Facility/DSS_65_Robledo_STDN_DS65		
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo		
        END Instance
        Instance Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo		
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Receiver/DL_DSN		
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Transmitter/Uplink		
        END Instance
        Instance Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Receiver/DL_DSN
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Receiver/DL_DSN		
        END Instance
        Instance Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Transmitter/Uplink
            Facility/DSS_65_Robledo_STDN_DS65/Sensor/Servo/Transmitter/Uplink		
        END Instance
        ...
        Instance Planet/Venus
            *		
            Planet/Venus		
        END Instance
        Instance Satellite/VenusSat
            Satellite/VenusSat		
            Satellite/VenusSat/Receiver/UL_Rcvr1		
            Satellite/VenusSat/Sensor/Imaging_Instrument1		
            Satellite/VenusSat/Sensor/Sun_Tracker1		
            Satellite/VenusSat/Transmitter/Downlink1		
        END Instance
        Instance Satellite/VenusSat/Receiver/UL_Rcvr1
            Satellite/VenusSat/Receiver/UL_Rcvr1		
        END Instance
        Instance Satellite/VenusSat/Sensor/Imaging_Instrument1
            Satellite/VenusSat/Sensor/Imaging_Instrument1		
        END Instance
        Instance Satellite/VenusSat/Sensor/Sun_Tracker1
            Satellite/VenusSat/Sensor/Sun_Tracker1		
        END Instance
        Instance Satellite/VenusSat/Transmitter/Downlink1
            Satellite/VenusSat/Transmitter/Downlink1		
        END Instance
        Instance Satellite/decaySat
            Satellite/decaySat		
        END Instance
        Instance Satellite/minAltSat
            Satellite/minAltSat		
