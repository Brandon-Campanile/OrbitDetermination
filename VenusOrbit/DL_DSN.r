                    ...
                    <VAR name = "Demodulator">
                        <VAR name = "QPSK">
                            <SCOPE Class = "Demodulator">
                                ...
                                <VAR name = "Description">
                                    <STRING>&quot;Demodulator capable of demodulating a QPSK modulated signal.&quot;</STRING>
                                </VAR>
                                <VAR name = "Type">
                                    <STRING>&quot;QPSK&quot;</STRING>
                                </VAR>
                                ...
                                <VAR name = "Gaussian">
                                    <SCOPE Class = "Antenna">
                                        ...
                                        <VAR name = "MainlobeGain">
                                            <QUANTITY Dimension = "RatioUnit" Unit = "units">
                                                <REAL>12698.63479991336</REAL>
                                            </QUANTITY>
                                        </VAR>
                                        <VAR name = "Beamwidth">
                                            <QUANTITY Dimension = "AngleUnit" Unit = "rad">
                                                <REAL>0.0278786253725679</REAL>
                                            </QUANTITY>
                                        </VAR>
...
BEGIN Extensions
    ...
    BEGIN AccessConstraints
        ...
        LinkMargin LinearMin  1.9952623150e+00 IncludeIntervals
        AtmosLoss LinearMin  3.9810717055e-01 IncludeIntervals
        CbObstruction Sun,Earth,Moon,Venus IncludeIntervals
        BER+I Max  1.0000000000e-05 IncludeIntervals
        RainLoss LinearMin  6.3095734448e-01 IncludeIntervals
