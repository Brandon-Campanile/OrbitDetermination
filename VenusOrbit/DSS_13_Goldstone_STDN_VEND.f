...
BEGIN Facility
    ...
    BEGIN CentroidPosition
        ...
        EcfLatitude		  3.5247164249999997e+01
        EcfLongitude		 -1.1679445900000002e+02
        EcfAltitude		  1.0704440000000000e+03
    ...
    BEGIN Extensions
        ...
        BEGIN Desc
            BEGIN ShortText
DSS 13 Goldstone STDN VEND
Name:           DSS 13 Goldstone STDN VEND
Country:        UnitedStates
Location:       Goldstone, California
Status:         Active
Type:           GroundStation
Alternate name: Venus Site
Notes:          NASA# 1513, ESN# 13 || Equipment: JPL DSS13 34m R and D   || Remarks: 10-85 JPL VENUS Research and Dev. Updated 11/2007.
Sources:                       NASA Directory of Station Locations Jan 27 2010
               http://deepspace.jpl.nasa.gov/dsn/history/dsn75.html
               http://deepspace.jpl.nasa.gov/dsndocs/810-005/301/301F.pdf
Last updated:   2009-12-14Antennas:       
  Type    :ParabolicReflector
  Diameter: 34 [Meters]
  Notes   : 34m Beam Waveguide (BWG).
            END ShortText
            BEGIN LongText
Name:           DSS 13 Goldstone STDN VEND
Country:        UnitedStates
