                                ...
                                <VAR name = "Gaussian">
                                    <SCOPE Class = "Antenna">
                                        ...
                                        <VAR name = "MainlobeGain">
                                            <QUANTITY Dimension = "RatioUnit" Unit = "units">
                                                <REAL>3083.368954274658</REAL>
                                            </QUANTITY>
                                        </VAR>
                                        <VAR name = "Beamwidth">
                                            <QUANTITY Dimension = "AngleUnit" Unit = "rad">
                                                <REAL>0.05657663651535823</REAL>
                                            </QUANTITY>
                                        </VAR>
...
BEGIN Extensions
    ...
    BEGIN AccessConstraints
        ...
        BitErrorRate Max  1.0000000000e-05 IncludeIntervals
        LinkMargin LinearMin  1.1455129414e+00 IncludeIntervals
